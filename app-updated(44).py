...
def format_cv_kv(cv_value, kv_value):
    ...
    return f"Cv: {cv_value:.1f} | Kv: {kv_value:.1f}"

# ========================
# FLUID LIBRARY - ENHANCED WITH CALCULATION FUNCTIONS
# ========================
FLUID_LIBRARY = {
    "Water": {
        "type": "liquid",
        ...
        "sg_reference": 1.0,  # SG at 4°C, 1 atm
        ...
        "sg_func": lambda t, p: calculate_specific_gravity("Water", t, p, "liquid"),
        "z_func": None
    },
    "air": {
        "type": "gas",
        ...
        "sg_reference": 1.0,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("air", t, p),
        "k_func": lambda t, p: calculate_specific_heat_ratio("air", t, p),
        "z_func": lambda t, p: calculate_compressibility_factor("air", t, p),
        "pv_func": None,
        "pc_func": lambda: CP.PropsSI('Pcrit', 'air') / 1e5,
        "rho_func": lambda t, p: calculate_density("air", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("air", t, p, "gas")
    },
    "Methane": {
        "type": "gas",
        "coolprop_name": "Methane",
        "molecular_weight": 16.04,
        "sg_reference": 0.554,  # Relative to air at standard conditions
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Methane", t, p),
        ...
        "pv_func": lambda t, p: calculate_vapor_pressure("Methane", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Methane') / 1e5,
        "rho_func": lambda t, p: calculate_density("Methane", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Methane", t, p, "gas")
    },
    "Steam": {
        "type": "steam",
        "coolprop_name": "Water",
        ...
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Water') / 1e5,
        "rho_func": lambda t, p: calculate_density("Water", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Water", t, p, "steam")
    },
    "CarbonDioxide": {
        "type": "gas",
        ...
        "sg_reference": 1.52,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("CarbonDioxide", t, p),
        ...
        "pv_func": lambda t, p: calculate_vapor_pressure("CarbonDioxide", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'CarbonDioxide') / 1e5,
        "rho_func": lambda t, p: calculate_density("CarbonDioxide", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("CarbonDioxide", t, p, "gas")
    },
    "Ammonia": {
        "type": "gas",
        ...
        "sg_reference": 0.59,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Ammonia", t, p),
        ...
        "pv_func": lambda t, p: calculate_vapor_pressure("Ammonia", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Ammonia') / 1e5,
        "rho_func": lambda t, p: calculate_density("Ammonia", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Ammonia", t, p, "gas")
    },
    "Hydrogen": {
        "type": "gas",
        ...
        "sg_reference": 0.0696,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Hydrogen", t, p),
        ...
        "pv_func": None,
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Hydrogen') / 1e5,
        "rho_func": lambda t, p: calculate_density("Hydrogen", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Hydrogen", t, p, "gas")
    },
    "20% Hydrogen + 80% Methane": {
        "type": "gas",
        "coolprop_name": None,
        "molecular_weight": 16.04 * 0.8 + 2.016 * 0.2,  # Weighted average
        "sg_reference": 0.455,
        "visc_func": lambda t, p: calculate_kinematic_viscosity_mixture(t, p, 0.2, 0.8, "Hydrogen", "Methane"),
        ...
        "pv_func": None,
        "pc_func": lambda: 0.2 * CP.PropsSI('Pcrit', 'Hydrogen') / 1e5 + 0.8 * CP.PropsSI('Pcrit', 'Methane') / 1e5,
        "rho_func": lambda t, p: calculate_density_mixture(t, p, 0.2, 0.8, "Hydrogen", "Methane"),
        "sg_func": lambda t, p: calculate_specific_gravity_mixture(t, p, 0.2, 0.8, "Hydrogen", "Methane", "gas")
    },
    "Natural Gas": {
        "type": "gas",
        "coolprop_name": "Methane",  # Using methane as approximation for natural gas
        "molecular_weight": 18.0,  # Average for natural gas
        "sg_reference": 0.6,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Methane", t, p),
        "k_func": lambda t, p: calculate_specific_heat_ratio("Methane", t, p),
        "z_func": lambda t, p: calculate_compressibility_factor("Methane", t, p),
    ...
    "Octane": {
        ...
        "sg_func": lambda t, p: calculate_specific_gravity("Octane", t, p, "liquid"),
        "z_func": None
    },
    "JP8": {
        "type": "liquid",
        "coolprop_name": "Decane",
        ...
        "sg_func": lambda t, p: calculate_specific_gravity_jet_fuel(t, p, "JP8"),
        "z_func": None
    },
    "JET A1": {
        "type": "liquid",
        ...
        "sg_func": lambda t, p: calculate_specific_gravity_jet_fuel(t, p, "JET A1"),
        "z_func": None
    },
    "Propane": {
        "type": "liquid",
        ...
        "k_func": lambda t, p: calculate_specific_heat_ratio("Propane", t, p),
        ...
        "sg_func": lambda t, p: calculate_specific_gravity("Propane", t, p, "liquid"),
        "z_func": lambda t, p: calculate_compressibility_factor("Propane", t, p)
    },
    "Ethanol": {
        "type": "liquid",
        ...
        "sg_reference": 0.789,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Ethanol", t, p),
        "k_func": None,
        "pv_func": lambda t, p: calculate_vapor_pressure("Ethanol", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Ethanol') / 1e5,
        "rho_func": lambda t, p: calculate_density("Ethanol", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Ethanol", t, p, "liquid"),
        "z_func": None
    },
    "Methanol": {
        "type": "liquid",
        ...
        "sg_reference": 0.791,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Methanol", t, p),
        "k_func": None,
        "pv_func": lambda t, p: calculate_vapor_pressure("Methanol", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Methanol') / 1e5,
        "rho_func": lambda t, p: calculate_density("Methanol", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Methanol", t, p, "liquid"),
        "z_func": None
    },
    "EthyleneGlycol": {
        "type": "liquid",
        "coolprop_name": "EthyleneGlycol",
        "molecular_weight": 62.07,
        "sg_reference": 1.113,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("EthyleneGlycol", t, p),
        "k_func": None,
        "pv_func": lambda t, p: calculate_vapor_pressure("EthyleneGlycol", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'EthyleneGlycol') / 1e5,
        "rho_func": lambda t, p: calculate_density("EthyleneGlycol", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("EthyleneGlycol", t, p, "liquid"),
        "z_func": None
    },
    "Nitrogen": {
        "type": "gas",
        ...
        "sg_reference": 0.967,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Nitrogen", t, p),
        "k_func": lambda t, p: calculate_specific_heat_ratio("Nitrogen", t, p),
        "z_func": lambda t, p: calculate_compressibility_factor("Nitrogen", t, p),
        "pv_func": lambda t, p: calculate_vapor_pressure("Nitrogen", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Nitrogen') / 1e5,
        "rho_func": lambda t, p: calculate_density("Nitrogen", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Nitrogen", t, p, "gas")
    },
    "Oxygen": {
        "type": "gas",
        ...
        "sg_reference": 1.105,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Oxygen", t, p),
        "k_func": lambda t, p: calculate_specific_heat_ratio("Oxygen", t, p),
        "z_func": lambda t, p: calculate_compressibility_factor("Oxygen", t, p),
        "pv_func": lambda t, p: calculate_vapor_pressure("Oxygen", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Oxygen') / 1e5,
        "rho_func": lambda t, p: calculate_density("Oxygen", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Oxygen", t, p, "gas")
    },
    "Argon": {
        "type": "gas",
        "coolprop_name": "Argon",
        ...
        "sg_reference": 1.380,
        "visc_func": lambda t, p: calculate_kinematic_viscosity("Argon", t, p),
        "k_func": lambda t, p: calculate_specific_heat_ratio("Argon", t, p),
        "z_func": lambda t, p: calculate_compressibility_factor("Argon", t, p),
        "pv_func": lambda t, p: calculate_vapor_pressure("Argon", t, p),
        "pc_func": lambda: CP.PropsSI('Pcrit', 'Argon') / 1e5,
        "rho_func": lambda t, p: calculate_density("Argon", t, p),
        "sg_func": lambda t, p: calculate_specific_gravity("Argon", t, p, "gas")
    }
}

# ========================
# FLUID PROPERTY FUNCTIONS - ENHANCED
# ========================
def calculate_specific_gravity(fluid_name: str, temp_c: float, press_bar: float, fluid_type: str) -> float:
    """
    Calculate specific gravity at given conditions.
    
    For liquids: SG = ρ_fluid / ρ_water (both at same conditions)
    For gases: SG = (MW_fluid / MW_air) * (Z_air / Z_fluid) * (P_std / P_actual) * (T_actual / T_std)
    
    Parameters:
    - fluid_name: Name from FLUID_LIBRARY
    - temp_c: Temperature in °C
    - press_bar: Pressure in bar
    - fluid_type: "liquid", "gas", or "steam"
    ...
    try:
        if fluid_name in FLUID_LIBRARY:
            fluid_data = FLUID_LIBRARY[fluid_name]
            
            if fluid_type == "liquid":
                # For liquids: SG = ρ_fluid / ρ_water (both at same conditions)
                rho_fluid = calculate_density(fluid_name, temp_c, press_bar)
                rho_water = calculate_density("Water", temp_c, press_bar)
                if rho_water > 0:
                    return rho_fluid / rho_water
                else:
                    return fluid_data.get("sg_reference", 1.0)
                    
            elif fluid_type == "gas":
                # For gases: SG = (MW_fluid / MW_air) * (Z_air / Z_fluid) * (P_std / P_actual) * (T_actual / T_std)
                # But for standard conditions in valve sizing, we use standard conditions
                
                # Get molecular weights
                MW_fluid = fluid_data.get("molecular_weight", 28.97)
                MW_air = 28.97
                
                # Calculate compressibility factors at standard conditions
                Z_fluid_std = calculate_compressibility_factor_at_standard(fluid_name)
                Z_air_std = calculate_compressibility_factor_at_standard("air")
                
                # Calculate densities at standard conditions
                rho_fluid_std = calculate_density_at_standard(fluid_name)
                rho_air_std = calculate_density_at_standard("air")
                
                if rho_air_std > 0:
                    # SG = ρ_fluid_std / ρ_air_std
                    return rho_fluid_std / rho_air_std
                else:
                    # Fallback: MW ratio
                    return MW_fluid / MW_air
                    
            elif fluid_type == "steam":
                # For steam, use ratio of density to air density at standard conditions
                rho_steam_std = calculate_density_at_standard("Water")  # Steam at standard conditions
                rho_air_std = calculate_density_at_standard("air")
                if rho_air_std > 0:
                    return rho_steam_std / rho_air_std
                else:
                    return 0.622  # Typical steam SG relative to air
    except:
        pass
    
    # Fallback to reference value
    if fluid_name in FLUID_LIBRARY:
        return FLUID_LIBRARY[fluid_name].get("sg_reference", 1.0)
    return 1.0

def calculate_specific_gravity_mixture(temp_c: float, press_bar: float, frac1: float, frac2: float, 
                                     fluid1: str, fluid2: str, fluid_type: str) -> float:
    """Calculate specific gravity for gas mixtures"""
    try:
        sg1 = calculate_specific_gravity(fluid1, temp_c, press_bar, fluid_type)
        sg2 = calculate_specific_gravity(fluid2, temp_c, press_bar, fluid_type)
        return frac1 * sg1 + frac2 * sg2
    except:
        pass
    
    # Fallback: weighted average of reference values
    if fluid1 in FLUID_LIBRARY and fluid2 in FLUID_LIBRARY:
        sg_ref1 = FLUID_LIBRARY[fluid1].get("sg_reference", 1.0)
        sg_ref2 = FLUID_LIBRARY[fluid2].get("sg_reference", 1.0)
        return frac1 * sg_ref1 + frac2 * sg_ref2
    return 1.0

def calculate_density_at_standard(fluid_name: str) -> float:
    """Calculate density at standard conditions (15°C, 1.01325 bar)"""
    try:
        if fluid_name in FLUID_LIBRARY:
            fluid_data = FLUID_LIBRARY[fluid_name]
            coolprop_name = fluid_data.get("coolprop_name", fluid_name)
            if coolprop_name:
                T_std = STANDARD_TEMPERATURE  # 15°C in K
                P_std = STANDARD_PRESSURE * 1e5  # Convert bar to Pa
                rho = CP.PropsSI('D', 'T', T_std, 'P', P_std, coolprop_name)
                return rho
    except:
        pass
    ...
    if fluid_name == "air":
        return 1.225  # kg/m³ at 15°C, 1 atm
    elif fluid_name == "Water":  # Steam
        return 0.804  # kg/m³ steam at 100°C, 1 atm (approx)
    elif fluid_name in FLUID_LIBRARY:
        # Estimate from molecular weight and ideal gas law
        MW = FLUID_LIBRARY[fluid_name].get("molecular_weight", 28.97)
        R = 8.314462618  # J/(mol·K)
        T_std = STANDARD_TEMPERATURE  # K
        P_std = STANDARD_PRESSURE * 1e5  # Pa
        return (P_std * MW / 1000) / (R * T_std)  # kg/m³
    return 1.225

def calculate_compressibility_factor_at_standard(fluid_name: str) -> float:
    """Calculate compressibility factor at standard conditions"""
    try:
        if fluid_name in FLUID_LIBRARY:
            fluid_data = FLUID_LIBRARY[fluid_name]
            coolprop_name = fluid_data.get("coolprop_name", fluid_name)
            if coolprop_name:
                T_std = STANDARD_TEMPERATURE  # 15°C in K
                P_std = STANDARD_PRESSURE * 1e5  # Convert bar to Pa
                Z = CP.PropsSI('Z', 'T', T_std, 'P', P_std, coolprop_name)
                return Z
    except:
        pass
    
    # For most gases at standard conditions, Z ≈ 1.0
    return 1.0

def calculate_specific_gravity_jet_fuel(temp_c: float, press_bar: float, fuel_type: str) -> float:
    """Calculate specific gravity for jet fuels"""
    try:
        # Calculate density at conditions
        density = calculate_density_jet_fuel(temp_c, press_bar, fuel_type)
        # Calculate water density at same conditions
        water_density = calculate_density("Water", temp_c, press_bar)
        if water_density > 0:
...
def calculate_kinematic_viscosity_jet_fuel(temp_c: float, press_bar: float, fuel_type: str) -> float:
    """Calculate kinematic viscosity for jet fuels"""
    try:
        # Try CoolProp first
        if fuel_type == "JP8":
...
def calculate_vapor_pressure_jet_fuel(temp_c: float, press_bar: float, fuel_type: str) -> float:
    """Calculate vapor pressure for jet fuels"""
    try:
        if fuel_type == "JP8":
...
def calculate_density_jet_fuel(temp_c: float, press_bar: float, fuel_type: str) -> float:
    """Calculate density for jet fuels"""
    try:
        if fuel_type == "JP8":
...
def calculate_kinematic_viscosity_mixture(temp_c: float, press_bar: float, frac1: float, frac2: float, 
                                        fluid1: str, fluid2: str) -> float:
    """Calculate kinematic viscosity for mixtures"""
    try:
        nu1 = calculate_kinematic_viscosity(fluid1, temp_c, press_bar)
        nu2 = calculate_kinematic_viscosity(fluid2, temp_c, press_bar)
        # Simple linear mixing rule (could be improved with more sophisticated models)
        return frac1 * nu1 + frac2 * nu2
    except:
        pass
    return 1.0
...
def calculate_vapor_pressure(fluid: str, temp_c: float, press_bar: float) -> float:
    """Calculate vapor pressure using CoolProp"""
    try:
        if fluid in FLUID_LIBRARY and FLUID_LIBRARY[fluid].get("coolprop_name"):
            fluid_name = FLUID_LIBRARY[fluid]["coolprop_name"]
            T = temp_c + C_TO_K
...
def calculate_density(fluid: str, temp_c: float, press_bar: float) -> float:
    ...
    if fluid == "Water":
        ...
        return 1000 - 0.2 * (temp_c - 4) + 0.006 * (temp_c - 4)**2
    elif fluid == "air":
        # Ideal gas law for air
        return (press_bar * 1e5) * 28.97 / (8.314462 * (temp_c + C_TO_K))
    elif fluid in FLUID_LIBRARY:
        # Try to estimate from reference value
        sg_ref = FLUID_LIBRARY[fluid].get("sg_reference", 1.0)
        fluid_type = FLUID_LIBRARY[fluid].get("type", "liquid")
        
        if fluid_type == "liquid":
            # For liquids, use water density as reference
            water_density = calculate_density("Water", temp_c, press_bar)
            return sg_ref * water_density
        else:
            # For gases, use ideal gas law
            MW = FLUID_LIBRARY[fluid].get("molecular_weight", 28.97)
            return (press_bar * 1e5) * MW / (8.314462 * (temp_c + C_TO_K))
    
    return 1000  # Default

def calculate_density_mixture(temp_c: float, press_bar: float, frac1: float, frac2: float, fluid1: str, fluid2: str) -> float:
    """Calculate density for mixtures"""
    try:
        T = temp_c + C_TO_K
        P = press_bar * 1e5
...
def calculate_kinematic_viscosity(fluid: str, temp_c: float, press_bar: float) -> float:
    """Calculate kinematic viscosity using CoolProp"""
    try:
        if fluid in FLUID_LIBRARY and FLUID_LIBRARY[fluid].get("coolprop_name"):
            fluid_name = FLUID_LIBRARY[fluid]["coolprop_name"]
            T = temp_c + C_TO_K
    ...
    if fluid.lower() == "water":
        ...
        # Sutherland's formula for air viscosity (in cSt)
        T = temp_c + C_TO_K
        mu0 = 1.716e-5  # Pa·s at 273.15K
        T0 = 273.15
        S = 110.4
        mu = mu0 * (T/T0)**1.5 * (T0 + S)/(T + S)
        rho = calculate_density("air", temp_c, press_bar)
        return mu / rho * 1e6 if rho > 0 else 15.0
    
    return 1.0  # Default

def calculate_specific_heat_ratio(fluid: str, temp_c: float, press_bar: float) -> float:
    """Calculate specific heat ratio (k=Cp/Cv) using CoolProp"""
    try:
        if fluid in FLUID_LIBRARY and FLUID_LIBRARY[fluid].get("coolprop_name"):
            fluid_name = FLUID_LIBRARY[fluid]["coolprop_name"]
            T = temp_c + C_TO_K
    ...
    elif fluid.lower() == "steam" or fluid.lower() == "water":
    ...
    elif fluid.lower() == "nitrogen":
        return 1.40 - 0.0001 * temp_c
    elif fluid.lower() == "oxygen":
        return 1.40 - 0.0001 * temp_c
...
def calculate_specific_heat_ratio_mixture(temp_c: float, press_bar: float, frac1: float, frac2: float, fluid1: str, fluid2: str) -> float:
    """Calculate specific heat ratio for mixtures"""
    try:
...
def update_fluid_properties_from_library(scenario_num, fluid_library, temp_c, p1_bar):
    """Update ALL fluid properties in session state when fluid library, temperature or pressure changes"""
    if fluid_library != "Select Fluid Library..." and fluid_library in FLUID_LIBRARY:
        fluid_data = FLUID_LIBRARY[fluid_library]
        fluid_type = fluid_data["type"]
        
        # Always recalculate specific gravity
        sg = calculate_specific_gravity(fluid_library, temp_c, p1_bar, fluid_type)
        st.session_state[f"sg_{scenario_num}"] = sg
...
# ========================
# CV_LIQUID FUNCTION WITH ENHANCED CALCULATION RECORD AND UPDATED SG CALCULATION
# ========================
def cv_liquid_with_record(flow: float, p1: float, p2: float, fluid_name: str, temp_c: float, 
                         fl_at_op: float, pv: float, pc: float, visc_cst: float, d_m: float, 
                         valve, fp: float = 1.0, cv_op: float = None,
                         record: CalculationRecord = None) -> tuple:
    """
    Calculate required Cv for liquid with enhanced calculation record
    Now includes specific gravity calculation from CoolProp
    """
    # Calculate specific gravity at actual conditions
    sg = calculate_specific_gravity(fluid_name, temp_c, p1, "liquid")
    ...
    if record:
        ...
        record.set_input_parameter("Fluid", fluid_name, "")
        record.set_input_parameter("Temperature", temp_c, "°C")
        record.set_input_parameter("Specific gravity SG", sg, "(calculated at conditions)")
        ...
        record.add_formula(
            ...
            "SG = ρ_fluid / ρ_water (both at same T,P)",
            "Specific gravity calculated at actual fluid conditions",
            {"ρ_fluid": "Fluid density at T,P", "ρ_water": "Water density at same T,P"}
        )
        record.add_formula(
    ...
    if p1 <= 0 or p2 < 0 or p1 <= p2:
        ...
        return 0, {'error': 'Invalid pressures', 'theoretical_cv': 0, 'fp': fp, 'fr': 1.0, 
                  'reynolds': 0, 'is_choked': False, 'ff': 0, 'dp_max': 0, 'sg': sg}
    ...
    if dp <= 0:
        ...
        return 0, {'theoretical_cv': 0, 'fp': fp, 'fr': 1.0, 'reynolds': 0, 
                  'is_choked': False, 'ff': 0, 'dp_max': 0, 'sg': sg}
    ...
    if record:
        ...
        record.set_result("Specific Gravity SG", sg, "", "Calculated at actual conditions")
        ...
        record.set_intermediate_value("Specific Gravity", sg, "", "Calculated at actual conditions")
...
# ========================
# CV_GAS FUNCTION WITH ENHANCED CALCULATION RECORD AND UPDATED SG CALCULATION
# ========================
def cv_gas_with_record(flow: float, p1: float, p2: float, fluid_name: str, temp_c: float, 
    ...
    Now includes specific gravity calculation at standard conditions
    """
    # Calculate specific gravity at standard conditions
    sg = calculate_specific_gravity(fluid_name, temp_c, p1, "gas")
    
    # Calculate other properties using CoolProp
    k = calculate_specific_heat_ratio(fluid_name, temp_c, p1)
    z = calculate_compressibility_factor(fluid_name, temp_c, p1)
    ...
    if record:
        ...
        record.set_input_parameter("Fluid", fluid_name, "")
        record.set_input_parameter("Temperature", temp_c, "°C")
        record.set_input_parameter("Specific gravity SG", sg, "(calculated at standard conditions)")
        ...
        record.add_formula(
            "Specific Gravity Calculation (Gas)",
            "SG = (MW_fluid / MW_air) * (Z_air / Z_fluid) * (P_std/P) * (T/T_std)",
            "Specific gravity calculated at standard conditions relative to air",
            {"MW_fluid": "Molecular weight of fluid", "MW_air": "Molecular weight of air (28.97)",
             "Z_air": "Compressibility of air at std conditions", "Z_fluid": "Compressibility of fluid at std conditions",
             "P_std": "Standard pressure (1.01325 bar)", "P": "Actual pressure", "T_std": "Standard temperature (15°C)",
    ...
    if p1 <= 0 or p2 < 0 or p1 <= p2:
        ...
        return 0, {'error': 'Invalid pressures', 'theoretical_cv': 0, 'fp': fp, 
                  ...
                  'xt_at_op': xt_at_op, 'xt_op_point': op_point, 'sg': sg, 'k': k, 'z': z}
    ...
    term = (sg * (temp_c + C_TO_K) * z) / x
    
    if record:
        record.add_step(5, "Calculate term inside square root", 
                       "Term = (SG * T * Z) / X", 
                       f"{term:.4f}", "",
                       {"SG": sg, "T": temp_c + C_TO_K, "Z": z, "X": x, "Term": term})
    ...
    if record:
        ...
        record.set_result("Specific Gravity SG", sg, "", "Calculated at standard conditions")
        record.set_result("Specific Heat Ratio k", k, "", "Cp/Cv from CoolProp")
        record.set_result("Compressibility Factor Z", z, "", "From CoolProp")
        
        # Store intermediate values
        record.set_intermediate_value("Temperature K", temp_c + C_TO_K, "K", "Absolute temperature")
    ...
    if x_actual > 0:
        y_alt = 0.667
        x_alt = x_actual
        term_alt = (sg * (temp_c + C_TO_K) * z) / x_alt
        if term_alt > 0:
...
# ========================
def cv_steam_with_record(flow: float, p1: float, p2: float, fluid_name: str, temp_c: float, 
                        xt_at_op: float, fp: float = 1.0, op_point: float = None,
                        cv_op: float = None, record: CalculationRecord = None) -> tuple:
    """
    ...
    rho = calculate_density(fluid_name, temp_c, p1)
    k = calculate_specific_heat_ratio(fluid_name, temp_c, p1)
    ...
    if record:
        ...
        record.set_input_parameter("Fluid", fluid_name, "")
        record.set_input_parameter("Temperature", temp_c, "°C")
        record.set_input_parameter("Density ρ", rho, "kg/m³ (from CoolProp)")
        record.set_input_parameter("Specific heat ratio k", k, "")
        record.set_input_parameter("Pressure drop ratio factor xT", xt_at_op, "")
        record.set_input_parameter("Piping factor Fp", fp, "")
    ...
    if p1 <= 0 or p2 < 0 or p1 <= p2:
        ...
        return 0, {'error': 'Invalid pressures', 'theoretical_cv': 0, 'fp': fp, 
                  'expansion_factor': 0, 'is_choked': False, 'x_crit': 0, 'x_actual': 0, 
                  'xt_at_op': xt_at_op, 'xt_op_point': op_point, 'rho': rho, 'k': k}
    ...
    if record:
        ...
        record.set_result("Is Choked", is_choked, "", "Choked flow status")
        record.set_result("Fk", fk, "", "Ratio of specific heats")
        record.set_result("Density ρ", rho, "kg/m³", "From CoolProp")
        record.set_result("Specific Heat Ratio k", k, "", "Cp/Cv from CoolProp")
...
def evaluate_valve_for_scenario_with_record(valve, scenario):
    ...
    fluid_name = scenario.get('fluid_library', 'Water' if fluid_type == 'liquid' else 'air')
...
def update_fluid_properties(scenario_num, fluid_library, temp_c, p1_bar):
    ...
    update_fluid_properties_from_library(scenario_num, fluid_library, temp_c, p1_bar)
